...
const PricingSection = () => {
  return (
    <div
      id="pricing-section"
      className="text-center my-40 container mx-auto py-48"
    >
      <h2 className="text-[#101727FF] text-center text-5xl font-extrabold  mb-4">
        Simple, Transparent Pricing
      </h2>
      <p className="text-[#627382FF] text-center">
      ...
      <div className="grid justify-center gap-4 md:grid-cols-2 xl:flex lg:justify-between lg:mx-48">
        ...
        <div className="card bg-base-400 shadow-2xl text-left p-6 my-6 hover:-translate-y-2 transition-all duration-300 mt-4">
          <div className="card-body">
            ...
            <span className="text-[#627382FF] text-left">
              Perfect for getting started
            </span>

            <p className="text-[#101727FF] text-4xl font-bold mt-6">
              $0<span className="text-[#627382FF] text-xl">/month</span>
            </p>
        ...
        <div className="card bg-linear-to-r from-[#a139f6] to-[#7504fe] shadow-2xl hover:-translate-y-2 transition-all duration-300 mt-4 text-left p-6 my-6 text-white">
          <div className="card-body">
            ...
            <div className="mt-6">
              <button className="bg-white font-semibold text-[#7b47e3] rounded-full flex items-center justify-center gap-2 border border-[#7b47e3] w-64 px-6 py-3 cursor-pointer">
                Start Pro Trial
              </button>
            </div>
          </div>
        ...
        <div className="card bg-base-400 shadow-2xl text-left p-6 my-6 hover:-translate-y-2 transition-all duration-300 mt-4">
          <div className="card-body">
            <span className="text-[#101727FF] text-2xl font-bold">
              Enterprise
            </span>
            <span className="text-[#627382FF] text-left">
            ...
            <p className="text-[#101727FF] text-4xl font-bold mt-6">
              $99<span className="text-[#627382FF] text-xl">/month</span>
            </p>
