...
const SingleProductData = ({singleProductData, totalCart, setTotalCart, total, setTotal}) => {
  ...
  <div className="card-body">
    ...
    <span className={`badge badge-xs font-medium px-3 py-2 ${tagType === 'best seller' ? 'bg-[#fef3c6FF] text-[#bb4d00FF]' : tagType === 'popular' ? 'bg-[#e1e7ffFF] text-[#ad0ef2]' : 'bg-[#dbfce7FF] text-[#3ca960]'} `}>{tagType}</span>
    </div>
