    ...
    <div className="card w-96 bg-base-100 shadow-md hover:-translate-y-2 transition-all duration-300 mt-4">
      <div className="card-body">
        <div className="flex justify-end">
          <span
            className={`badge badge-xs font-medium px-3 py-2 ${tagType === "best seller" ? "bg-[#fef3c6FF] text-[#bb4d00FF]" : tagType === "popular" ? "bg-[#e1e7ffFF] text-[#ad0ef2]" : "bg-[#dbfce7FF] text-[#3ca960]"} `}
          >
            {tagType}
          </span>
        </div>
        ...
        <h3 className="text-[#101727FF] text-2xl font-bold">
          ${price}
          <span className="text-[#627382FF] text-[16px] font-normal">
            /{period}
          </span>
        </h3>
        ...
        <div className="mt-6">
          <button
            className={`font-bold w-80 text-white rounded-full px-6 py-3 ${
              isSelected
